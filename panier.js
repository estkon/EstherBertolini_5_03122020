...
`
    if (k === produitEnregistreDansLocalstorage.length) {
        ...
        const produitExistant = produit.id_ProduitSelectionner == idProduit && produit.optionCouleur.split(" ").join("") == colorProduit ;
...
//Ecouter les boutons +
btn_plus.forEach(btn => adjustProductQuantity (btn , 'plus') );
